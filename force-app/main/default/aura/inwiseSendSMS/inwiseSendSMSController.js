({
  doInIt: function(component, event, helper){
    ...
    helper.contactFieldsSelectOptions(component);
  ...
  onChangeTemplate: function(component, event, helper){
    var template = component.find("templates");
    var smsbody = component.find("smsbody");
    var newvalue = "";
    if(smsbody.get("v.value") == undefined){
      newvalue = ("#landing_" + template.get("v.value") + "#");
    }
    else{
      newvalue = (smsbody.get("v.value") + " #landing_" + template.get("v.value") + "#");
    }
  ...
  onChangeMergeField: function(component, event, helper){
    helper.getContactJson(component);
  },
